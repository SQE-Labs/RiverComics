...
public class Hamburger extends BasePage {
   ...
   private By tellUsHowWeAreDoing= By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.RelativeLayout");
    ...
    private By shareTab = By.xpath("//android.widget.TextView[@text='Share']");
    ...
    private By FAQs = By.xpath("//android.widget.TextView[@text='FAQs']");
    ...
    private By confirmEmailToastMsg = By.id("//android.widget.Toast)[1]");
    ...
    private By termsAndConditionContainer = By.id("com.river.comics.us:id/webView");
    ...
    private By passwordChangedSuccessfully = By.xpath("/hierarchy/android.widget.Toast");
    ...
    public String getPasswordChangedText() throws InterruptedException {
        waitForVisibility(passwordChangedSuccessfully);
    ...
    public boolean isContactUsTabPresent() throws InterruptedException {
        ...
        return isDisplayed(tellUsHowWeAreDoing);
    }
    ...
    public Boolean hamburgerIconPresent() throws InterruptedException {
       return isDisplayed(humburgerIcon);

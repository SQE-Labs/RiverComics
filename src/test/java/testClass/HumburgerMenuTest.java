...
public class HumburgerMenuTest extends BaseTest {
    ...
    //139
    @Test(priority = 1, enabled = true, description = "Verify that confirm email field left blank")
    public void confirmEmailBlank_InUpdatedEmail() throws Exception {
        ...
        Hamburger.clickSettingsTab();
        Hamburger.clickUpdateEmail();
        Hamburger.enterCurrentEmail("anuragrana12123@gmail.com");
        Hamburger.enterNewEmail("anuragrana12123@gmail.com");
        Hamburger.clickSubmit();
        
        Assertion.assertEquals(Hamburger.getValidationMessageConfirmEmailBlank(),"Please confirm new email address");
        login.closeApp();
    ...
    //144
    @Test(priority = 1, enabled = true, description = "Verify that updated email appear below the rivercomics logo")
...
//    //158  --- This test case cannot be automated due to sign up functionality can not be done because of captcha issue.
    ...
    //161
    @Test(priority = 0, enabled = true, description = "Verify that FAQ's page opens up")
    ...
    //163
    @Test(priority = 0, enabled = true, description = "Verify that user is able to logout after selecting 'YES' button")
